...
(function ($PS) {
  ...
  var newMediaRecorder = function newMediaRecorder(dictMonadEffect) {
  ...
  var getUserMedia = function getUserMedia($2) {
...
(function ($PS) {
  ...
  var MessageData = function MessageData(x) {
    return x;
  };
  ...
  var readMessageData = function readMessageData(value) {
